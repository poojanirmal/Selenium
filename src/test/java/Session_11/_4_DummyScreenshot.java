...
public class _4_DummyScreenshot {
	...
	public void scnCapture()
	{
		...
		try 
		{
			FileUtils.copyFile(file, new File(System.getProperty("user.dir")+"\\src\\test\\java\\Session_11\\ScreenShots\\"+searchFileName+System.currentTimeMillis()+".jpg"));
